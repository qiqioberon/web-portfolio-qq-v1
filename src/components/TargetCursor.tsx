...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  const isMobile = useMemo(() => {
    ...
    return hasCoarsePointer || (hasTouchScreen && isSmallScreen) || isMobileUserAgent;
  }, []);
  ...
  useEffect(() => {
    if (isMobile || prefersReducedMotion || !cursorRef.current || !spinTl.current) return;
  ...
  }, [spinDuration, isMobile, prefersReducedMotion]);
