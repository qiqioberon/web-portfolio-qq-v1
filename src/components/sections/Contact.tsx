...
const whatsappLinks = {
	english: `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
		"Hi Qiqi, I found your portfolio and would like to discuss a project with you.",
	)}`,
	indonesian: `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
		"Halo Qiqi, saya menemukan portfolio Anda dan ingin berdiskusi mengenai sebuah proyek.",
	)}`,
} as const;
