    ...
    <section ref={sectionRef} id="contact" className="py-32 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <div ref={contentRef}>
          ...
          <h2 ref={titleRef} className="text-4xl md:text-5xl lg:text-6xl font-black mb-8 opacity-0">
            Let's Work Together
          </h2>
          <p ref={descRef} className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-12 leading-relaxed opacity-0">
