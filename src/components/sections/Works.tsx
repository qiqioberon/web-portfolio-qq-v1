			...
			<div className="max-w-7xl mx-auto">
				<div ref={headerRef} className="mb-16">
					...
					<p className="mt-5 max-w-2xl text-base leading-7 text-muted-foreground md:text-lg">
						Product engineering, applied AI, and data stories—organized for
						faster browsing without hiding the full case studies.
					</p>
				</div>
				...
				<Tabs defaultValue="all">
					<TabsList
						...
						aria-label="Filter portfolio selected work by category"
					>
